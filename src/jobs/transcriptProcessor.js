/**
 * transcriptProcessor.js — Shared transcript extraction logic
 *
 * Used by:
 *   src/routes/zoom.js          — automatic webhook-triggered processing
 *   process-transcript.js       — manual backfill tool
 *
 * ⚠️  This is the single source of truth for:
 *   - The GPT-4o extraction prompt
 *   - The Airtable field mapping
 *   - The deterministic lead score (computeLeadScore)
 *
 * When you change any of these, both consumers update automatically.
 */
...
// Computed from structured fields — does NOT involve GPT.
...
// Maps extracted GPT fields to Airtable Appointments field names.
// ⚠️  If you rename a field in Airtable, update it here — both consumers update automatically.

function buildAirtableFields(fields, extraFields = {}) {
  return {
...
module.exports = { extractFields, computeLeadScore, buildAirtableFields };
